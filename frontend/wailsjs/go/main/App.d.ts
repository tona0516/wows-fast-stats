...
export function ApplyRequiredUserConfig(arg1:string,arg2:string):Promise<domain.RequiredConfigError>;
...
export function ValidateRequiredConfig(arg1:string,arg2:string):Promise<domain.RequiredConfigError>;
