...
//
//	mockgen -source=local_file_interface.go -destination ../mock_repository/local_file_interface.go -package mock_repository
//
...
func (m *MockLocalFileInterface) TempArenaInfo(installPath string) (model.TempArenaInfo, error) {
	m.ctrl.T.Helper()
