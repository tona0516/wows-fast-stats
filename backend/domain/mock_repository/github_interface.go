...
//
//	mockgen -source=github_interface.go -destination ../mock_repository/github_interface.go -package mock_repository
//
...
func (m *MockGithubInterface) LatestRelease() (model.GHLatestRelease, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LatestRelease")
	ret0, _ := ret[0].(model.GHLatestRelease)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
