...
//
//	mockgen -source=storage_interface.go -destination ../mock_repository/storage_interface.go -package mock_repository
//
...
func (m *MockStorageInterface) AlertPlayers() ([]model.AlertPlayer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) ExpectedStats() (model.ExpectedStats, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) UserConfig() (model.UserConfig, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) UserConfigV2() (model.UserConfigV2, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) WriteAlertPlayers(players []model.AlertPlayer) error {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) WriteExpectedStats(expectedStats model.ExpectedStats) error {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) WriteUserConfig(config model.UserConfig) error {
	m.ctrl.T.Helper()
...
func (m *MockStorageInterface) WriteUserConfigV2(config model.UserConfigV2) error {
	m.ctrl.T.Helper()
