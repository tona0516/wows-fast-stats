...
const (
	...
	ErrStringNotFound            failure.StringCode = "[B301] ファイルが見つかりません"
	ErrStringRead                failure.StringCode = "[B302] ファイル読み込みに失敗しました"
	ErrStringWrite               failure.StringCode = "[B303] ファイル書き込みに失敗しました"
